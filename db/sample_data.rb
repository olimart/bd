...
s.books.create!(tome: '1', title: "NIVEAU 1".humanize, author: "CORBEYRAN, ROLLIN".titleize, editor: "GLENAT".humanize)
s.books.create!(tome: '2', title: "NIVEAU 2".humanize, author: "CORBEYRAN, ROLLIN".titleize, editor: "GLENAT".humanize)
s.books.create!(tome: '3', title: "NIVEAU 3".humanize, author: "CORBEYRAN, ROLLIN".titleize, editor: "GLENAT".humanize)


s = Serie.create!(name: "BLACK OP".humanize)
s.books.create!(tome: '1', title: "1".humanize, author: "DESBERG, LABIANO".titleize, editor: "DARGAUD".humanize)
s.books.create!(tome: '2', title: "2".humanize, author: "DESBERG, LABIANO".titleize, editor: "DARGAUD".humanize)
s.books.create!(tome: '3', title: "3".humanize, author: "DESBERG, LABIANO".titleize, editor: "DARGAUD".humanize)
s.books.create!(tome: '4', title: "4".humanize, author: "DESBERG, LABIANO".titleize, editor: "DARGAUD".humanize)
s.books.create!(tome: '5', title: "5".humanize, author: "DESBERG, LABIANO".titleize, editor: "DARGAUD".humanize)
s.books.create!(tome: '6', title: "6".humanize, author: "DESBERG, LABIANO".titleize, editor: "DARGAUD".humanize)
s.books.create!(tome: '7', title: "7".humanize, author: "DESBERG, LABIANO".titleize, editor: "DARGAUD".humanize)
...
s.books.create!(tome: '5', title: "O.P.A SUR LE KREMLIN".humanize, author: "BARTOLL, GARRETA".titleize, editor: "DARGAUD".humanize)
...
s = Serie.create!(name: "IRS".humanize)
s.books.create!(tome: '1', title: "LA VOIE FISCALE".humanize, author: "VRANCKEN, DESBERG".titleize, editor: "LOMBARD".humanize)
s.books.create!(tome: '2', title: "LA STRATEGIE HAGEN".humanize, author: "VRANCKEN, DESBERG".titleize, editor: "LOMBARD".humanize)
